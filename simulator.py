"""
simulator.py — BNF Engine V16 Full Comprehensive Master Simulator
...
- Rolling 5-year local cache in data/master/ with daily append-and-prune.
- Fully supports all strategies: S1, S2, S3, S4, S5, S6, S7.
